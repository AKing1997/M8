...
public class Modificar extends AsyncTask<Libro, String, Void> {
    ...
    protected Void doInBackground(Libro... libro) {
        try {
            ...
            this.url = new URL(this.urlString+"/modificar");

            this.conexion = (HttpURLConnection) this.url.openConnection();
            this.conexion.setRequestMethod("PUT");
            ...
            Uri.Builder build = new Uri.Builder()
                    .appendQueryParameter("id", String.valueOf(lib.getId()))
