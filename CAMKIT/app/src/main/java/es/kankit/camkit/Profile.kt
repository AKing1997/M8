...
class Profile(dbHelper: DBHelper) : Fragment() {
     ...
     override fun onCreateView(
        ...
        savedInstanceState: Bundle?
         ...
         val spinnerTextArray = resources.getStringArray(R.array.spinner_setting);

         val sharedPreference: SharedPreferences = v.context.getSharedPreferences("PREFERENCE_NAME", Context.MODE_PRIVATE);
         var editor = sharedPreference.edit();
         val s: Spinner = v.findViewById<Spinner>(R.id.settingBtnSpinner);
         if( s != null){
             val aA = ArrayAdapter(v.context, android.R.layout.simple_spinner_item, resources.getStringArray(R.array.spinner_setting));
